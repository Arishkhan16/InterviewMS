...
Join us in transforming the recruitment process into something smarter, faster, and more reliable.          </p>
      ...
      {/* About Section
      <div id="about" className="bg-white text-gray-800 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-8">About Us</h2>
          <p className="text-lg text-center leading-relaxed">
            AI VIS is a state-of-the-art recruitment platform powered by AI, designed to
            streamline the hiring process for companies and connect job seekers with the
            best opportunities. Our mission is to revolutionize how talent meets
            opportunity.
          </p>
        </div>
      </div> */}
