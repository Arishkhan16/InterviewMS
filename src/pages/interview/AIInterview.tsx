...
export function AIInterview() {
  ...
  const mediaRecorder = useRef<MediaRecorder | null>(null); // Define mediaRecorder
    ...
    if (file) {
      ...
      if (file.type === "text/plain") {
        ...
        reader.onload = () => {
          ...
          // Add the file content as a new message in the chat
          const newMessage: Message = {
            id: Date.now().toString(),
            text: fileContent, // Use the content of the uploaded file
            sender: "user",
          };

          setMessages((prev) => [...prev, newMessage]); // Add to the messages state
        };
    ...
    if (isRecording) {
      ...
      navigator.mediaDevices
        ...
        .then((stream) => {
          ...
          mediaRecorder.current = recorder; // Set the mediaRecorder reference
          ...
          recorder.onstop = () => {
            ...
            setAudioChunks([]); // Clear chunks after message is sent
          };
